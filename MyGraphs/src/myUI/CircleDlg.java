...
import javax.swing.*;
import myGraph.*;
public class CircleDlg extends javax.swing.JDialog {

    public CircleDlg(java.awt.Frame parent) {
        super(parent,true);
        this.ox = null;
    ...
    public CircleDlg(java.awt.Frame parent,Circle c) {
        super(parent,true);
        int x=(int)(parent.getLocationOnScreen().x+parent.getWidth()*0.3);
        int y=(int)(parent.getLocationOnScreen().y+parent.getHeight()*0.2);
        setLocation(x, y);
    ...
    private void initComponents() {
        ...
        String s="300";
        if(ox!=null)s=String.valueOf(ox.getPoint().x);
        jTextField1.setText(s);

        s="200";
        if(ox!=null)s=String.valueOf(ox.getPoint().y);
        jTextField2.setText(s);

        s="200";
        if(ox!=null)s=String.valueOf(ox.getR());
...
public static MyShape getCircle(java.awt.Frame f) {
                CircleDlg dialog = new CircleDlg(f);
                dialog.setVisible(true);
                return dialog.ox;
    }
public static MyShape getCircle(java.awt.Frame f,Circle c) {
                CircleDlg dialog = new CircleDlg(f,c);
                dialog.setVisible(true);
                return dialog.ox;
    }
    Circle ox;
